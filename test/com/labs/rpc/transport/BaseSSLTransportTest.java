...
/**
 * Basic ssl transport tests
 * @author Benjamin Dezile
 */
public class BaseSSLTransportTest extends TestCase {
		...
		new AsyncTask("ServerThread") {
			public void run() {
				try {
					...
					SSLSocket clientSock = (SSLSocket)servSock.accept();
	...
	private class TransportImpl extends BaseSSLTransport {
		...
		protected SSLSocketFactory getSSLSocketFactory() throws Exception {
			String ksPath = "/Users/ben/testServerKeyStore";
			String pwd = "123abc";
			return this._getSSLSocketFactory(ksPath, pwd);
		}
